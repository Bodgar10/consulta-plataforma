  ...
  return (
    <main className="min-h-screen flex items-center justify-center px-6 py-16">
      <div className="card max-w-md w-full text-center space-y-4">
        <span className="badge-pending mx-auto">Pendiente de confirmación</span>
        <h1 className="page-title text-2xl">Revisa tu correo</h1>
        <p className="muted">
          Te enviamos los siguientes pasos para completar tu pago y confirmar tu
          sesión. Si no lo ves en unos minutos, revisa spam.
        </p>
