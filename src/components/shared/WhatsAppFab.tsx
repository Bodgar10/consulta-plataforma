 ...
 * ver PANEL_PREFIXES). Esquina inferior derecha — convención estándar de
 * WhatsApp; no colisiona con TourFab porque ese solo vive en el panel,
 * donde este componente ya no se renderiza.
 */
export function WhatsAppFab() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-2">
      {showBubble && (
        <div className="relative bg-cream-0 rounded-[14px] pl-4 pr-5 py-3 shadow-[0_8px_28px_-6px_rgba(31,51,46,0.35)] max-w-[240px] animate-[fadeIn_0.3s_ease-out] border-l-[3px] border-pine-600">
          <p className="text-sm text-pine-900 leading-snug">
            Charla personalmente conmigo si tienes alguna duda
          </p>
          <div className="absolute -bottom-1.5 right-6 w-3 h-3 bg-cream-0 rotate-45" />
        </div>
      )}
      <a
        ...
        className="w-14 h-14 rounded-full bg-[#25D366] shadow-[0_4px_16px_-4px_rgba(31,51,46,0.35)] flex items-center justify-center hover:brightness-95 hover:scale-105 transition-all"
      >
